...
export TF_VAR_namespace="sagemaker-kubeflow"
export TF_VAR_stage="test"
export TF_VAR_name="eks-kfsgm-cluster"
...
terraform apply -auto-approve -var-file=${TERRAFORM_DIR}/conf.tfvars ${TERRAFORM_DIR}